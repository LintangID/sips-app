...
<body>
    <center>
       @include('includes.kop-surat')
        ...
        <table border="0" width="480">
            <tr>
                <td style="text-align: justify">Adalah benar-benar peserta didik aktif di SMA Negeri 3 Boyolali kelas <b>{{ $data['kelas'] }}, Tahun Pelajaran {{ $data['tahun_pelajaran'] }}</b>, dan peserta didik tersebut telah lulus tahun {{ $data['tahun_kelulusan'] }} serta berkelakuan baik.</td>
            </tr>
            <br>
            <tr>
