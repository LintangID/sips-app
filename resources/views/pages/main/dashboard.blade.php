                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">Sistem Informasi Pengelolaan Surat</div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        <p class="text-gray-700 mb-0">Di Sistem Informasi Pengelolaan Surat</p>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-xl-6 mb-4">
                    <div class="card bg-primary text-white h-100">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="{{ route('surat-masuk.index') }}">Selengkapnya</a>
                ...
                <div class="col-lg-12 col-xl-6 mb-4">
                    <div class="card bg-warning text-white h-100">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between small">
                            <a class="text-white stretched-link" href="{{ route('surat-keluar.index') }}">Selengkapnya</a>
                            <div class="text-white"><i class="fas fa-angle-right"></i></div>
                        </div>
                    </div>
                </div>
