                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <!-- Form Group (Role User)-->
                                <div class="mb-3">
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="role">Role</label>
                                        <select class="form-select" name="role_id" value="{{ old('role') }}"  required autofocus >
                                            ...
                                            <option value="0" >Petugas Surat</option> --}}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="konfirmasi_password">Konfirmasi Password</label>
                                        <input class="form-control @error('konfirmasi_password') is-invalid @enderror" name="konfirmasi_password" type="password"/>
