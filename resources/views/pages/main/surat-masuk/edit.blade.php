                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('no_agenda') is-invalid @enderror" value="{{ old('no_agenda',$item->no_agenda) }}" name="no_agenda" placeholder="Nomor Agenda" required>
                                    </div>
                                    @error('no_agenda')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('asal_surat') is-invalid @enderror" value="{{ old('asal_surat',$item->asal_surat) }}" name="asal_surat" placeholder="Nomor Surat" required>
                                    </div>
                                    @error('asal_surat')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('diteruskan_kepada') is-invalid @enderror" value="{{ old('diteruskan_kepada',$item->diteruskan_kepada) }}" name="diteruskan_kepada" placeholder="diteruskan_kepada" required>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('nama_ttd_penerima') is-invalid @enderror" value="{{ old('nama_ttd_penerima',$item->nama_ttd_penerima) }}" name="nama_ttd_penerima" placeholder="nama_ttd_penerima" required>
                                    </div>
