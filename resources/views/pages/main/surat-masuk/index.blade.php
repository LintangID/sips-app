                    ...
                    <div class="card card-header-actions mb-4">
                        <div class="card-header">
                            ...
                            <div class="card-header-actions">
                                ...
                                <a class="btn btn-sm btn-primary" href="{{ route('form-print-surat-masuk') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped  table-hover table-sm table-bordered text-sm text-center " id="crudTable" width='1300px'>
                                    <thead>
                                        <tr>
                                            <th width="5%">No.</th>
                                            <th width="5%">No. Agenda</th>
                                            <th width="10%">Tgl Agenda</th>
